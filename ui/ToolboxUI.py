...
class Ui_SegmentationToolbox(object):
    def setupUi(self, SegmentationToolbox):
        ...
        self.actionDuplicate_roi = QtWidgets.QAction(SegmentationToolbox)
        self.actionDuplicate_roi.setObjectName("actionDuplicate_roi")
        ...
        self.menuROI.addAction(self.actionDuplicate_roi)
    ...
    def retranslateUi(self, SegmentationToolbox):
        ...
        self.actionDuplicate_roi.setText(_translate("SegmentationToolbox", "Duplicate..."))
