...
class Ui_SegmentationToolbox(object):
    def setupUi(self, SegmentationToolbox):
        ...
        SegmentationToolbox.resize(311, 1317)
        ...
        self.maskInterpolationGroup = QtWidgets.QGroupBox(self.mainUIWidget)
        ...
        self.verticalLayout_10.addWidget(self.interpolateButton)
        ...
        self.verticalLayout_9.addWidget(self.maskInterpolationGroup)
