...
class Ui_SegmentationToolbox(object):
    def setupUi(self, SegmentationToolbox):
        ...
        SegmentationToolbox.resize(472, 828)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 447, 1267))
        ...
        self.model_info_button.setStyleSheet("padding-left: 5px;\n"
"padding-right: 5px;")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 472, 32))
